  ...
  return (
    <div className="flex justify-center items-start min-h-full w-full">
      <form className="w-full max-w-3xl p-6 bg-white rounded shadow">
        <Title align='left' font='outfit' title='Add Rooms' subTitle="Fill in the details carefully—accurate room details, pricing, and amenities enhance the booking experience."/>
